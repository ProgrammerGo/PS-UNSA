package com.example.bicigo.controller;
...
import com.example.bicigo.maps.TrazarRutas;
import com.example.bicigo.model.Actividad;
import com.example.bicigo.model.ListaPunto;
import com.example.bicigo.model.Punto;
        ...
        */
        ...
        startServiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new JSON_Task().execute("https://lab7dnpa.herokuapp.com/api/puntoactividad/" + item.id);
            }
        });
