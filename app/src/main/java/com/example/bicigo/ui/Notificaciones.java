...
import com.example.bicigo.controller.AdaptadorNotificacion;
import com.example.bicigo.model.NotificacionUsuario;
...
public class Notificaciones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Notificaciones.JSON_Task().execute("https://lab7dnpa.herokuapp.com/api/notificacionusuario/" + miUsuario.getIdUsuario());
